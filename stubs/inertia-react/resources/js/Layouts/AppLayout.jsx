            ...
            <div className="min-h-screen bg-gray-100">
                <nav className="bg-white border-b border-gray-100">
                        ...
                        <div className="flex justify-between h-16">
                            <div className="flex">
                                ...
                                <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                    <NavLink href={route('dashboard')} active={window.location.pathname === '/dashboard'}>
                                        Dashboard
                                    </NavLink>
                                </div>
                            </div>
                                    ...
                                    <Dropdown align="right" width="60">
                                        ...
                                        <Dropdown.Content>
                                            <div className="w-60">
                                                ...
                                                <Dropdown.Link href={route('teams.show', {team: user?.current_team.id})}>Team Settings</Dropdown.Link>
                                                {jetstream?.canCreateTeams && (
                                                    <Dropdown.Link href={route('teams.create')}>Create New Team</Dropdown.Link>
                                                )}
                                                            ...
                                                            <Dropdown.Link key={team.id}
                                                                ...
                                                                <div className="flex items-center">
                                                                    {team.id === user?.current_team_id && (
                                                                        <svg className="me-2 h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5">
                    ...
                    <div className={(showingNavigationDropdown ? 'block' : 'hidden') + " sm:hidden"}>
                        ...
                        <div className="border-t border-gray-200">
                            <div className="px-4">
                                {user?.profile_photo_url && <img className="h-10 w-10 rounded-full" src={user?.profile_photo_url} alt={user?.name}/>}
                                <div
                                    className="font-medium text-base text-gray-800">{user.name}</div>
                            ...
                            {jetstream?.hasTeamFeatures && (
                                <>
                                    ...
                                    {jetstream?.canCreateTeams && (
                                        <ResponsiveNavLink href={route('teams.create')}>Create New Team</ResponsiveNavLink>
                                    )}
                                    {user?.all_teams.length > 1 && (
                                        <>
                                            <div className="border-t border-gray-200" />
